...
public class DialogueVertexAnimator {
    ...
    private readonly TextMeshProUGUI textBox;
    private readonly float textAnimationScale;
    private readonly AudioSourceGroup audioSourceGroup;
    public DialogueVertexAnimator(TextMeshProUGUI _textBox) {
        textBox = _textBox;
    ...
    public IEnumerator AnimateTextIn(List<DialogueCommand> commands, string processedMessage, float secondsPerCharacter, Action onFinish = null) {
        textAnimating = true;
